    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col">
        ...
        <select
          ...
          class="w-full cursor-pointer appearance-none rounded-lg border border-base-content/15 bg-base-200 px-3 py-2 pr-8 text-sm text-base-content transition-all duration-200 hover:bg-base-300/50 focus:border-primary focus:outline-none"
          style="
        ...
        <div class="flex flex-col gap-4">
          ...
          >
            <select
              ...
              "
            >
              <option value="" disabled selected>{{ t('ipShort') }}</option>
