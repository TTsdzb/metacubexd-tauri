...
- Do not delete `apps/desktop`, `apps/server`, or generated-looking Tauri
  ...
  pieces for future Android/iOS work.
...
- Keep `lib.rs`/`main.rs`, `#[cfg_attr(mobile, tauri::mobile_entry_point)]`,
  ...
  They preserve future Android/iOS reachability.
...
- `release-tauri.yml` publishes unsigned Linux, Windows, and macOS artifacts
  from `tauri-v*` tags as draft GitHub Releases.
